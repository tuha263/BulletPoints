...
{
    [Inject] public EmoTileData emoTileData { get; set; }

    [Inject] public IGameStateData gameStateData { get; set; }

    [Inject] public CurrentEmoMediator currentEmoMediator { get; set; }
    ...
    private IEnumerator SampleEmoSound()
    {
        int note = emoTileData.data.Note;
