...
{
    [Inject] public LoadingProgressView view { get; set; }

    [Inject] public IGameStateData gameStateData { get; set; }

    [Inject] public IClefsDataManager clefDataManager { get; set; }

    [Inject] public ITimeSigsDataManager timeSigsDataManager { get; set; }

    public override void OnRegister()
    {
        gameStateData.currentTimeSig =
            timeSigsDataManager.Datas.Find(timeSig => timeSig.TIMESIGSTYPE == TimeSigsType._4_4);
