...
/// 
[System.Serializable]
public class db_StaffSetting : ScriptableObject 
{
    ...
    public db_StaffSettingData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new db_StaffSettingData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public db_StaffSettingData FindByKey(string key)
    //{
